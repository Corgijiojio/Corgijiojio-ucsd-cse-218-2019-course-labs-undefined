...
public class GameView extends SurfaceView{
    ...
    private void drawCanvas(Canvas canvas, boolean drawPlayer){
        ...
        canvas.drawText(game.getResources().getString(R.string.onscreen_score_text) + " " + game.pointManager.points
    ...
    private void createPowerUp(){
        // Toast
        if(game.pointManager.points >= Toast.POINTS_TO_TOAST /*&& powerUps.size() < 1*/ && !(player instanceof NyanCat)){
            // If no powerUp is present and you have more than / equal 42 points
            if(game.pointManager.points == Toast.POINTS_TO_TOAST){    // First time 100 % chance
    ...
    public void changeToNyanCat(){
        game.pointManager.achievement_toastification = true;
        ...
        musicManager.musicShouldPlay = true;
        musicManager.start();
    }
    ...
    public int getSpeedX(){
        ...
        int speedIncrease = (int) (this.getWidth() / 600f * (game.pointManager.points / 4));
